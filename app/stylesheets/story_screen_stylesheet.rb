class StoryScreenStylesheet < ApplicationStylesheet
  ...
  def collection_view(st)
    ...
    st.background_color = [199, 46, 0].uicolor
    ...
    bg_image.scale_to_fill([50000, 50000], position: [:center, :left, :right, :top, :top_left, :top_right, :bottom_left, :bottom_right].sample)
